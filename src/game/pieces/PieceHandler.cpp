...
//         const BoardPos temporaryBoardPos=BoardUtils::getBoardPosForAnim({absPosMoved.x+GAME_X_POS_SHIFT,absPosMoved.y+GAME_Y_POS_SHIFT});
//         currPiece->setBoardPos(temporaryBoardPos);
//         if(!pair.first){
//             return;
//         }
//     }
...
//     if(pair.first){
//         std::unique_ptr<ChessPiece>& pieceCastling=_pieces[_currPlayerId][pair.second.first];
//         const Point absPosPieceCastling=BoardUtils::getAbsPosForAnim(pieceCastling->getBoardPos());
//         const Point absPosShiftedPieceCastling(absPosPieceCastling.x-GAME_X_POS_SHIFT,absPosPieceCastling.y-GAME_Y_POS_SHIFT);
//         const Point targetAbsPosPieceCastling=BoardUtils::getAbsPosForAnim(pair.second.second);
//         const Point absPosMovedPieceCastling=BoardUtils::getPosOfMovedPiece(absPosShiftedPieceCastling,targetAbsPosPieceCastling,pieceCastling->getPieceType());
        
//         if(targetAbsPosPieceCastling!=absPosMovedPieceCastling){
//             const BoardPos temporaryBoardPos=BoardUtils::getBoardPosForAnim({absPosMovedPieceCastling.x+GAME_X_POS_SHIFT,absPosMovedPieceCastling.y+GAME_Y_POS_SHIFT});
...
//         if(pair.first){
//             pair.second.second=BoardUtils::getInvBoardPosForAnim(pair.second.second,WidgetFlip::HORIZONTAL_AND_VERTICAL);
//         }
//     }

//     currPiece->setBoardPos(_targetBoardPos);

//     const PieceType currPieceType=currPiece->getPieceType();
//     if(PieceType::PAWN==currPieceType){
//         ChessPiece* const chessPiecePtr=currPiece.get();
//         Pawn* const pawnPiecePtr=static_cast<Pawn*>(chessPiecePtr);
...
//         std::unique_ptr<ChessPiece>& pieceCastling=_pieces[_currPlayerId][pair.second.first];
//         pieceCastling->setBoardPos(pair.second.second);
//         ChessPiece* const chessPiecePtr=pieceCastling.get();
...
//             rookPiecePtr->setWhenFirstMoveIsMade();
//         }
//         pair.first=false; pair.second.first=INVALID_RSRC_ID; pair.second.second=BoardPos(INVALID_RSRC_ID,INVALID_RSRC_ID); 
//     }
...
//             if(Defines::BLACK_PLAYER_ID==_currPlayerId){
//                 const Point absPosTakenInv=BoardUtils::getInvAbsPosForAnim(absPosTaken,WidgetFlip::HORIZONTAL_AND_VERTICAL);
//                 const BoardPos boardPosTakenInv=BoardUtils::getBoardPosForAnim(absPosTakenInv);
...
//     if(_gameProxy->isPromotionActive()){
//         if(Defines::BLACK_PLAYER_ID==_currPlayerId){
//             const BoardPos targetBoardPos=BoardUtils::getInvBoardPosForAnim(_targetBoardPos,WidgetFlip::HORIZONTAL_AND_VERTICAL);
//             currPiece->setBoardPos(targetBoardPos);
//         }
//     } else {
//         _collisionIdx=INVALID_RSRC_ID;
