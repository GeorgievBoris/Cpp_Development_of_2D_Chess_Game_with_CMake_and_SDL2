...
/*
User provided EventDataTypes enum is created in order not to include the SDL_event.h header.
The EventDataTypes enum can be extended at any time with certain event if it is needed.
(Not all SDL_events are listed here)
*/
...
enum Key {
    ...
    KEY_NUMPAD_NUMLOCK=1073741907, //SDLK_NUMLOCKCLEAR
